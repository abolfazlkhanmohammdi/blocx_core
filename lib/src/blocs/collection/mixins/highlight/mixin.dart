...
mixin BlocxCollectionHighlightableMixin<Entity extends BlocxBaseEntity, Payload>
  ...
  @override
  bool initHighlight() {
    on<BlocxCollectionEventHighlightItem<Entity>>(highlightItem);
    on<BlocxCollectionEventClearHighlightedItem<Entity>>(clearHighlightedItem);
    return true;
  }
  ...
  FutureOr<void> highlightItem(
    BlocxCollectionEventHighlightItem<Entity> event,
    Emitter<BlocxCollectionState<Entity>> emit,
  ) async {
    _highlightedItemIds.add(event.item.identifier);
    emitState(emit);
    if (autoClearHighlight) {
      add(BlocxCollectionEventClearHighlightedItem<Entity>(item: event.item));
    }
  }
  ...
  Future<void> clearHighlightedItem(
    BlocxCollectionEventClearHighlightedItem<Entity> event,
    Emitter<BlocxCollectionState<Entity>> emit,
  ) async {
