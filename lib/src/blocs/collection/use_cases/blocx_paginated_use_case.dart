...
///
/// ```dart
/// class GetOrdersUseCase extends BlocxPaginationUseCase<BlocxPaginatedInput, Order> {
///   final OrderRepository _repo;
///   GetOrdersUseCase(this._repo);
///
///   @override
///   Future<BlocxUseCaseResult<BlocxPage<Order>>> perform(BlocxPaginatedInput input) async {
